    ...
    <section id="contact" className="py-20 lg:py-28 bg-gray-50">
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-10">
        <div className="text-center mb-14">
          <span className="text-xs font-bold tracking-widest uppercase text-[#CC0000] mb-3 block">Get In Touch</span>
          <h2 className="text-3xl lg:text-4xl xl:text-5xl font-extrabold text-[#1A0A5E] mb-4">Contact Us</h2>
          <p className="text-gray-500 max-w-xl mx-auto text-base">
            Have a question or need a custom quote? We&apos;re always available — 24 hours a day, 7 days a week.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          <div>
            <div className="space-y-5 mb-8">
              {[
                { icon: Phone, label: 'Call Us', value: '09039661885', href: 'tel:09039661885', color: '#1A0A5E' },
                { icon: MessageCircle, label: 'WhatsApp', value: '07052258764', href: 'https://wa.me/2347052258764', color: '#25D366' },
                { icon: Mail, label: 'Email', value: 'info.247sparkle@gmail.com', href: 'mailto:info.247sparkle@gmail.com', color: '#CC0000' },
                { icon: MapPin, label: 'Location', value: 'Lagos, Nigeria', href: '#', color: '#F5C200' },
              ].map((item) => {
                ...
                return (
                  <a
                    ...
                    className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-100 hover:border-[#F5C200]/30 hover:shadow-card transition-all duration-200 group"
                  >
                    <div
            ...
            <div className="rounded-2xl overflow-hidden border border-gray-200 h-48 bg-gray-100 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 font-medium">Lagos, Nigeria</p>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-[#F5C200]/30 ${
                    errors.name ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-[#F5C200]'
                  }`}
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-[#F5C200]/30 ${
                      errors.email ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-[#F5C200]'
                    }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-[#F5C200]/30 ${
                      errors.phone ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-[#F5C200]'
                    }`}
                  />
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 rounded-xl border text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-[#F5C200]/30 resize-none ${
                    errors.message ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-[#F5C200]'
                  }`}
                />
